...
#if defined(JL_USE_NEW_PM) && defined(_COMPILER_ASAN_ENABLED_)
#define JL_USE_NEW_PM_WITH_ASAN
#endif
...
#if defined(_OS_DARWIN_) && defined(_CPU_AARCH64_) || defined(JL_USE_NEW_PM_WITH_ASAN) || defined(JL_FORCE_JITLINK)
